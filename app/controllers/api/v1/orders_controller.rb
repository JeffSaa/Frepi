class  Api::V1::OrdersController < Api::V1::ApiController
  ...
  def create
    ...
    if order.buy(current_user, params[:products])
      if order.save
        ...
        OrderCreatedMailer.notification_client(order, current_user).deliver_now
  ...
  def params_order
    params.permit(:expiry_time, :arrival_time, :scheduled_date, :comment, :address, :telephone, :payment)
  end
